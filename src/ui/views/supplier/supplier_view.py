"""
Vue de gestion des fournisseurs - Interface utilisateur.
...
class SupplierView(BaseView):
    """Vue de gestion des fournisseurs. Herite de BaseView."""
    ...
    def _init_search_section(self):
        ...
        add_btn = self._make_btn(
            "Nouveau Fournisseur", "plus-circle", "#2ecc71", "#27ae60",
            "#1e8449", w=190, slot=lambda: self.add_supplier_requested.emit()
        )
    ...
    def _on_edit_clicked(self):
        ...
        if idx.isValid():
            ...
            self.show_error("Veuillez selectionner un fournisseur.", "Selection requise")
    ...
    def _apply_theme_styles(self):
        ...
        self.setStyleSheet(self.styleSheet() + f"""
            ...
            QTableView#supplierTable::item:selected:!active {{
                background-color: {selection};
                color: white;
            }}
